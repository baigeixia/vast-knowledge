...
public class PreAuthorizeAspect
{
    ...
    public static final String POINTCUT_SIGN =
              "@annotation(com.vk.common.security.annotation.RequiresLogin) || "
            + "@annotation(com.vk.common.security.annotation.RequiresPermissions) || "
            + "@annotation(com.vk.common.security.annotation.RequiresRoles)";
