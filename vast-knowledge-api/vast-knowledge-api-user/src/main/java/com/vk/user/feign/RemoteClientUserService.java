...
@FeignClient(contextId = "remoteClientUserService", value = ServiceNameConstants.CLIENT_USER_SERVICE, fallbackFactory = RemoteClientUserFallbackFactory.class)
public interface RemoteClientUserService {

    @GetMapping("/apUser/info/{username}")
